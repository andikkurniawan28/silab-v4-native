    ...
    <li class="nav-item">
        ...
        <div id="collapseInputDataOffFarm" class="collapse" aria-labelledby="headingUtilities"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="analisa_air_index.php">Analisa %Air</a>
                <a class="collapse-item" href="analisa_ph_index.php">Analisa pH & Turbidity</a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseLaporan" class="collapse" aria-labelledby="headingUtilities"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="laporan_mandor_index.php">Laporan Mandor</a>
            </div>
        </div>
    </li>
