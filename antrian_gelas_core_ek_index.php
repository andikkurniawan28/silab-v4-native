...
<div class="container-fluid">
    <h4 class="mb-3">Antrian Gelas Core EK</h4>

    <div class="row">

        <!-- LEFT : FORM -->
        <div class="col-md-3">
            <form method="POST" action="antrian_gelas_core_ek_proses.php">
                ...
                <a href="antrian_gelas_core_ek_delete_all.php"
...
$(function(){
    $('#ampasTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: 'antrian_gelas_core_ek_fetch.php',
            type: 'POST'
        },
        order: [[0,'desc']],
        columns: [
