...
$stmt = $conn->prepare("SELECT * FROM in_process_weighings WHERE id = ?");
...
<div class="container-fluid">
    <h4 class="mb-3">Edit Timbangan RS OUT</h4>

    <form method="POST" action="timbangan_rs_out_update.php">
        ...
        <a href="timbangan_rs_out_index.php" class="btn btn-secondary">Batal</a>
    </form>
</div>
